...
Our estimated timing for biopoesis is compatible with the earliest well-accepted geologic evidence of life in the 3.5 Ga Pilbara block of western Australia \citep{Walter_1980}. Older geologic evidence of life exists, but is inconclusive. For example, \citet{Bell_2015} discovered graphite inclusions in a 4.1 Ga zircon grain with $^{13}$C depletions compatible with biological activity, but this is a tentative biosignature because there are abiotic mechanisms for making isotopically light carbon \citep{Javaux_2019}. If the \citet{Bell_2015} finding is indeed a sign of life, then it would be mostly compatible with our estimating timing in Figure \ref{fig:time_and_mass}, because we find that there is only a $\sim 10\%$ chance of life starting after 4.1 Ga.

Beyond the early Earth, it is temping to extrapolate our result for the likelihood of the origin of life to exoplanets, however, we must do so with caution because planet's orbiting different stars may have bombardment histories unlike the Hadean. Planets in the habitable zone of an M-type star during the stellar main-sequence phase were interior to the habitable zone for several hundred million years during the super luminous pre-main-sequence phase \citep{Luger_2015}. \citet{Lichtenberg_2022} uses N-body simulations to show that, for planets hosted by M-dwarfs, large asteroid impacts are not useful for prebiotic chemistry because big impacts most likely occur within 100 million years of planet formation during the stellar pre-main-sequence when the planet is outside of the habitable zone. The pre-main-sequence phase is not an issue for an impact-induced origin of life on planets orbiting sun-like stars because the phase only lasts 10s Myrs, while large asteroid impacts occur for 100s Myrs \citep{Lichtenberg_2022}.

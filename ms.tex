...
We emphasize that these results rely upon a variety of assumptions including the premise that some of the first life-like molecules were RNA replicators which were built abiotically from nitriles like HCN and HCCCN. Additionally, our calculations assume that an impact that vaporizes the ocean also sterilizes the planet, but this may not be the case because microbes could have possibly survived in the deep subsurface \citep{Sleep_1989,Grimm_2018}.

If life began in an RNA-first process after an impact, then this work suggests that origin of life on Earth was a fairly likely event (at least a 20\% chance) and was indeed strongly favored (92\% chance) under optimistic assumptions. Given that all rocky planets form from accretionary impacts, our work supports and optimistic outlook for life on exoplanets and future searches for biosignatures. 
